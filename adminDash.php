        ...
        <div class="row mt-5 ms-3 me-3 my-5">
            <div class="col-1 px-0">
                <ul class="nav flex-column border-end border-top border-bottom">
                    ...
                    <li class="nav-item">
                        <span class="sideNav"><a class="nav-link sideNav" href="#adminCustomer" onclick="toggleCustomer()">Customers</a></span>
                    </li>
                    <li class="nav-item">
                        <span class="sideNav"><a class="nav-link sideNav" href="#adminAgent" onclick="toggleAgent()">Agents</a></span>
                    </li>
                    <li class="nav-item">
                        <span class="sideNav"><a class="nav-link sideNav" href="#adminAdmin" onclick="toggleAdmin()">Admins</a></span>
                    </li>
                </ul>
            </div>
            <div class="col-11">
                <?php
                include "view/adminCharts.php";
                include "view/adminCustomer.php";
                include "view/adminAgent.php";
                include "view/adminAdmin.php";
                ?>
            </div>
        </div>
