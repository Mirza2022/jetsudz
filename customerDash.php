        ...
        <div class="row mt-5 ms-3 me-3 my-5">
            <div class="col-1 px-0">
                <ul class="nav flex-column border-end border-top border-bottom">
                    ...
                    <li class="nav-item">
                        <span class="sideNav"><a class="nav-link sideNav" href="#" onclick="toggleCustSchedule()">All Bookings</a></span>
                    </li>
                    <li class="nav-item">
                        <span class="sideNav"><a class="nav-link sideNav" href="#" onclick="toggleCustProfile()">View Profile</a></span>
                    </li>
                </ul>
            </div>
            <div class="col-11">
                <?php
                include "view/custSchedules.php";
                //include "view/custProfile.php";
                ?>
            </div>
        </div>
